...
import { t as characters } from "./characters-DoaM_dvD.js";
import { r as plants } from "./plants-CONbauOt.js";
import { n as songs } from "./songs-CbMbfwRj.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { BookOpen, CloudSun, Languages, Leaf, Music2, Shield, Sprout, Users } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("main", { children: [
		/* @__PURE__ */ jsxs("section", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-[#e11d74] via-[#ff8a00]/50 to-transparent" }),
				/* @__PURE__ */ jsxs("div", {
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: characters.map((c, i) => /* @__PURE__ */ jsxs(Link, {
					to: "/crew/$slug",
					params: { slug: c.slug },
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: plants.slice(0, 8).map((p, i) => /* @__PURE__ */ jsxs(Link, {
						to: "/plants/$slug",
						params: { slug: p.slug },
		...
		/* @__PURE__ */ jsxs("section", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("ul", {
					...
					children: songs.map((s, i) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(Link, {
						to: "/sing/$slug",
						params: { slug: s.slug },
			...
			children: [
				...
				/* @__PURE__ */ jsx(Button, {
					...
					children: /* @__PURE__ */ jsxs(Link, {
						to: "/family",
						children: [/* @__PURE__ */ jsx(Users, { className: "size-4" }), " Start a family challenge"]
					})
				})
			]
		}),
