import { s as Button } from "./router-D-7YjPqO.js";
import { n as mapRegions, r as plants, t as getPlant } from "./plants-CONbauOt.js";
import { useEffect, useMemo, useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { CloudRain, Sprout, Sun } from "lucide-react";
//#region src/lib/farm/engine.ts
var STAGES = [
	"seed",
	"sprout",
	"leaf",
...
//#endregion
//#region src/components/farm/LivingFarm.tsx
function LivingFarm() {
	...
	const [clock, setClock] = useState(() => (/* @__PURE__ */ new Date()).getHours());
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					weather === "rain" ? /* @__PURE__ */ jsx(Rain, {}) : null,
					weather === "sun" ? /* @__PURE__ */ jsx("div", {
						className: "farm-sun",
						"aria-hidden": true
					}) : null,
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: mapRegions.map((r) => /* @__PURE__ */ jsx("button", {
									type: "button",
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: SCENE_CHIPS.map((s) => /* @__PURE__ */ jsx("button", {
									type: "button",
									className: "farm-chip whitespace-nowrap",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: farm.plots.map((p) => /* @__PURE__ */ jsx(PlotBed, {
							plot: p,
							active: picked === p.id,
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Button, {
							...
							children: [/* @__PURE__ */ jsx(CloudRain, { className: "size-4" }), " Open the water tap"]
						}), /* @__PURE__ */ jsxs(Button, {
							type: "button",
							size: "lg",
							variant: "secondary",
							onClick: shine,
							children: [/* @__PURE__ */ jsx(Sun, { className: "size-4" }), " Open the polytunnel"]
						})]
					}),
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
						...
						children: seeds.map((pl) => /* @__PURE__ */ jsxs("button", {
							type: "button",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("img", {
							...
							}), farm.basket.length === 0 ? /* @__PURE__ */ jsx("p", {
								className: "mt-1 text-sm text-muted",
								children: "Harvest ripe beds. Food for sharing, not a shop."
							}) : /* @__PURE__ */ jsx("ul", {
								className: "mt-2 flex flex-wrap gap-2",
								children: farm.basket.map((h, i) => /* @__PURE__ */ jsx("li", {
...
function Infra({ src, title, text, action, onClick }) {
	return /* @__PURE__ */ jsxs("button", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("span", { className: "absolute inset-0 bg-gradient-to-t from-black/75 to-transparent" }),
			/* @__PURE__ */ jsxs("span", {
...
function PlotBed({ plot, active, onSelect, onHarvest }) {
	...
	return /* @__PURE__ */ jsxs("button", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(GrowingBody, {
				stage: plot.stage,
				progress: plot.progress,
				colour
			}),
			plot.stage === "flower" || plot.stage === "fruit" ? /* @__PURE__ */ jsx("span", {
				className: "farm-bee",
				"aria-hidden": true
			}) : null,
			/* @__PURE__ */ jsx("span", {
			...
			plot.stage !== "empty" ? /* @__PURE__ */ jsx("span", {
				...
				children: /* @__PURE__ */ jsx(Sprout, { className: "size-7 opacity-70" })
			})
		]
	});
}
function GrowingBody({ stage, progress, colour }) {
	...
	return /* @__PURE__ */ jsxs("svg", {
		...
		children: [
			...
			stage === "seed" || stage === "sprout" ? /* @__PURE__ */ jsx("ellipse", {
				cx: "50",
				cy: "86",
				rx: "7",
				ry: "5",
			...
			[
				...
				"flower",
				"fruit"
			].includes(stage) ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("ellipse", {
				cx: "38",
				cy: 70 - rank * 20,
				rx: "12",
				ry: "7",
			...
			stage === "leaf" || stage === "flower" || stage === "fruit" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("ellipse", {
				cx: "32",
				cy: 58 - rank * 10,
				rx: "10",
				ry: "6",
			...
			stage === "flower" || stage === "fruit" ? /* @__PURE__ */ jsx("circle", {
				cx: "50",
				cy: 40 - rank * 6,
				r: "8",
				fill: "#f0c84a"
			}) : null,
			stage === "fruit" ? /* @__PURE__ */ jsx("circle", {
				cx: "50",
				cy: "36",
				r: "11",
				fill: colour,
...
function Rain() {
	return /* @__PURE__ */ jsx("div", {
		...
		"aria-hidden": true,
		children: Array.from({ length: 18 }, (_, i) => /* @__PURE__ */ jsx("span", { style: {
			left: `${i * 17 % 100}%`,
...
function FarmPage() {
	return /* @__PURE__ */ jsxs("main", {
		...
		children: [/* @__PURE__ */ jsx("p", {
			...
			className: "mt-5",
			children: /* @__PURE__ */ jsx(LivingFarm, {})
		})]
	});
}
//#endregion
