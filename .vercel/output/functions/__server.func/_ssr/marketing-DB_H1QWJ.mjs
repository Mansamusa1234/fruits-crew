...
//#region node_modules/.nitro/vite/services/ssr/assets/marketing-DB_H1QWJ.js
var BRAND = {
	name: "Fruits Crew",
	creator: "Darren-neil",
	...
	description: "Fruits Crew is a joyful worldwide children’s learning and animation universe where fruits, vegetables, seeds, soil, roots, water, weather, plants, animals and the Earth can talk, sing and learn together.",
	cultures: "Caribbean culture is one part of a global family, alongside African, British, Asian, European, Middle Eastern, Pacific, Indigenous and other living cultures.",
	hashtags: [
		"#FruitsCrew",
		"#BackToNature",
...
function youtubeDescription(title, body, cta) {
	return [
		`${title}`,
		"",
		body,
...
var youtubePacks = [{
	...
	description: youtubeDescription(episodes[0].title, episodes[0].marketing.description, episodes[0].marketing.parentCta),
	tags: [
		"Fruits Crew",
		"kids songs original",
...
var launchWeek = [
	{
		day: "Day 1",
		item: "Publish Wake Up, Little Seed! (long + Shorts chorus)."
	},
	{
		day: "Day 2",
		item: "Post parent carousel: jar-bean activity."
	},
	{
		day: "Day 3",
		item: "Upload Count the Mangoes karaoke."
	},
	{
		day: "Day 4",
		item: "School/library email with lesson cards."
	},
	{
		day: "Day 5",
		item: "Rain, Sun, Grow movement clip."
	},
	{
		day: "Day 6",
		item: "Family Sunday: Roots Hold Hands bedtime cut."
	},
	{
		day: "Day 7",
		item: "Review comments with an adult; no child-to-child replies."
	}
];
var pressBoilerplate = `${BRAND.name} is a joyful worldwide children’s learning and animation universe created by ${BRAND.creator}. ${BRAND.description} ${BRAND.cultures} Child-facing message: ${BRAND.childMessage} Parent-facing message: ${BRAND.parentMessage}`;
//#endregion
export { schoolLessons as a, pressBoilerplate as i, CHANNELS as n, socialPosts as o, launchWeek as r, youtubePacks as s, BRAND as t };
