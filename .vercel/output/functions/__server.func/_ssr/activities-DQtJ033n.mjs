//#region node_modules/.nitro/vite/services/ssr/assets/activities-DQtJ033n.js
var activities = [
	{
		slug: "jar-bean",
		...
		whatYouNeed: [
			"Clear jar",
			"Paper towel",
			"Dried beans (food beans, not mystery seeds)",
			"Water"
		],
		steps: [
